...
static void attr_add(void *cookie, struct lsa_attr *attr)
{
	...
	printf(" = ");
	lsa_attr_print_data(stdout, attr, rl->name_hints);
	printf("\n");
}
...
attr_mod(void *cookie, struct lsa_attr *aattr, struct lsa_attr *battr)
{
	...
	printf(" = ");
	lsa_attr_print_data(stdout, aattr, rl->name_hints);
	printf(" -> ");
	lsa_attr_print_data(stdout, battr, rl->name_hints);
	printf("\n");
}
...
static void lsa_add(void *cookie, struct lsa *a)
{
	...
	lsa_print_id_name(stdout, a->id, rl->name_hints);
	printf("]\n");
