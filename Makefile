...
topomon:	topomon.c adj_rib.c adj_rib.h conf.c conf.h lsa.c lsa.h lsa_deserialise.c lsa_deserialise.h lsa_diff.c lsa_diff.h lsa_path.c lsa_path.h lsa_print.c lsa_print.h rib_listener.h rib_listener_debug.c rib_listener_debug.h util.c util.h x509.c x509.h
		gcc -Wall -g -o topomon topomon.c adj_rib.c conf.c lsa.c lsa_deserialise.c lsa_diff.c lsa_path.c lsa_print.c rib_listener_debug.c util.c x509.c -lgnutls -lini_config -livykis -lnettle
