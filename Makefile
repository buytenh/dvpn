...
dgpd:		dgpd.c adj_rib.c adj_rib.h conf.c conf.h dgp_writer.c dgp_writer.h loc_rib.c loc_rib.h lsa.c lsa.h lsa_deserialise.c lsa_deserialise.h lsa_diff.c lsa_diff.h lsa_path.c lsa_path.h lsa_print.c lsa_print.h lsa_serialise.c lsa_serialise.h rib_listener.h rib_listener_debug.c rib_listener_debug.h rib_listener_to_loc.c rib_listener_to_loc.h util.c util.h x509.c x509.h
		gcc -Wall -g -o dgpd dgpd.c adj_rib.c conf.c dgp_writer.c loc_rib.c lsa.c lsa_deserialise.c lsa_diff.c lsa_path.c lsa_print.c lsa_serialise.c rib_listener_debug.c rib_listener_to_loc.c util.c x509.c -lgnutls -lini_config -livykis -lnettle
